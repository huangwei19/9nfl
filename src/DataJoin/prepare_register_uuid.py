...
import os
import grpc
from DataJoin.common import coordinator_data_service_pb2
from DataJoin.common import coordinator_data_service_pb2_grpc
import time
...
if __name__ == "__main__":
    ...
    coord_stub = coordinator_data_service_pb2_grpc.PairServiceStub(coord_channel)
    remote_ip = None
    host_ip = None
    while not remote_ip:
    ...
    while remote_ip and host_ip:
        ...
        request = coordinator_data_service_pb2.Request(ip_port=ip_port)
        ...
        if res_status.status:
            raise Exception("register coordinator: <%s> fail !" % res_status.error_message)
        while not res_status.status:
            ...
            if status_code:
                ...
                service_pair = pair_service_info_response.service_pair
