...
#ifndef JDFL_BRIDGE_INTERFACE_H_
#define JDFL_BRIDGE_INTERFACE_H_
...
class BridgeInterface {
 public:
  ...
  virtual void RequestTrainStartAsync(const TrainerWorkerMessage* request,
                             TrainerWorkerResponse* response, StatusCallback done) = 0;
...
#endif  // JDFL_BRIDGE_INTERFACE_H_
