...
const std::string FILES_TMP_DIR = "_tmp/";

const std::string FILE_GET_CMD = "file_get.sh";

const std::string ENV_FILE_GET_CMD = "_FILE_GET_CMD";

const std::string ENV_FILE_CLEAN_CMD = "_FILE_CLEAN_CMD";
...
std::string ParseEnvConfig(const std::string& env, const std::string& default_val) {
  std::string val;
